...
class _NotesListPageState extends State<NotesListPage> {
  ...
  void _loadSortPref() async {
    final prefs = await SharedPreferences.getInstance();
    setState(() => _newestFirst = prefs.getBool('sortNewestFirst') ?? true);
  }

  void _saveSortPref(bool value) async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool('sortNewestFirst', value);
  }
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: FutureBuilder<List<NoteModel>>(
          future: _svc.loadCachedNotes(),
          builder: (context, snapshot) {
            final cachedNotes = snapshot.data ?? [];

            return StreamBuilder<List<NoteModel>>(
              initialData: cachedNotes,
                          ...
                          children: [
                            if (_selectionMode) ...[
                              ...
                              TextButton(
                                ...
                                child: Text(
                                  _selected.length == _latest.length &&
                                      _latest.isNotEmpty
                                      ? 'Clear'
                                      : 'Select all',
                                ),
                              ...
                              ...[
                                const Icon(
                                    Icons.sticky_note_2, color: _brand, size: 24),
                    ...
                    slivers: [
                      ...
                      SliverFillRemaining(
                        ...
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.sticky_note_2_outlined, size: 64,
                    ...
                    SliverPadding(
                      ...
                      sliver: SliverList(
                        delegate: SliverChildBuilderDelegate(
                              (context, i) {
                            final n = notes[i];
                            final first = n.imagesB64.isNotEmpty
                                ? n.imagesB64.first
                                : null;
                                      ...
                                      child: AnimatedScale(
                                        ...
                                        child: Container(
                                          decoration: const BoxDecoration(
                                              ...
                                              color: Colors.white),
                                          child: const Icon(
                                              Icons.check_circle, color: _brand),
                                        ),
                                      ),
                                    ),
                                ],
